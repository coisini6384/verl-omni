...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--image_size", type=int, default=512, help="Resize and pad condition images to this square size."
    )
    ...
    train_df = _convert_split(
        input_dir=input_dir, split="train", max_samples=args.train_size, image_size=args.image_size
    )
